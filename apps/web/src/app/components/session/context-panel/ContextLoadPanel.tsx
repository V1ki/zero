...
export function ContextLoadPanel({ summary, layout = 'wide' }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <ContextLoadOverviewSection summary={summary} isSidebar={isSidebar} />
        <ContextLoadDistributionSection summary={summary} isSidebar={isSidebar} />
        <ContextLoadLatestRequestSection summary={summary} isSidebar={isSidebar} />
      </div>
    </section>
  )
}

function ContextLoadOverviewSection({
  summary,
  isSidebar,
}: {
  summary: ContextTokenSummary
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="mt-0.5 text-[11px] text-[var(--color-text-disabled)]">current estimate</p>
        </div>
      </div>
...
function ContextLoadDistributionSection({
  summary,
  isSidebar,
}: {
  summary: ContextTokenSummary
...
function ContextLoadLatestRequestSection({
  summary,
  isSidebar,
}: {
  summary: ContextTokenSummary
